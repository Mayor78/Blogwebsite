            ...
            <div className='bg-white  shadow-2xl'> 
              ...
              <form className='  justify-center inline-block' >
                ...
                <input type='text'
                 ...
                 name='cpassword' value={userData.cpassword} 
                 onChange={changeInputHandler}
                 className='border-2 border-gray-300 p-2 mx-10 mt-5 sm:w-full md:w-[80%] lg:w-[85%] shadow-md rounded-2xl' />
              ...
              <p className='flex justify-center items-center'>Already have an account? <Link to="/login" className='text-red-500 hover:underline'> Login</Link></p>
            </div>
    </div>
  )
}
